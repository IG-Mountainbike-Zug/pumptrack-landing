    ...
    return (
        <div className="bg-white py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none" id="more-info">
                    <p className="text-base font-semibold leading-7 text-sky-600">Pumptrack Cham: Ein
                        Erfolgsprojekt!</p>
                    <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Nun wollen
                        wir auch {env.SITE_CITY} mit einem Pumptrack begeistern!</h1>
                    <div
                        ...
                        <div>
                            ...
                            <p className="mt-6">
                                ...
                                Körperbewegungen, dem sogenannten &quot;Pumpen&quot;, können Fahrer ohne
                                Pedaleinsatz
                            ...
                            <p className="mt-6">
                                ...
                                besuche gerne die Webseite des Pumptrack Cham unter <Link
                                className="text-sky-600 hover:text-sky-500 transition ease-in-out duration-150 font-semibold underline cursor-pointer hover:no-underline focus:no-underline"
                                href="https://pumptrackcham.ch" target="_blank">pumptrackcham.ch</Link>, wo du
